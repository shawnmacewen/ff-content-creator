...
const roadmapIdeas: RoadmapIdea[] = [
  ...
  {
    title: 'KIT Export Summary',
    status: 'Next',
    theme: 'Generate KIT Workflow',
    summary: 'Add a summary tab beside the generated previews that lists every KIT asset and gives users clear ways to export or send the package.',
    details: [
      'Add a KIT summary tab next to the current output preview so users can scan the generated campaign assets as a list.',
      'Show each generated asset with format, title/label, status, and a quick action to inspect or copy the individual output.',
      'Add export options for practical downstream formats such as plain text, Markdown, HTML, JSON, CSV, and bundled files when image assets are included.',
      'Plan external delivery options such as “Send to external CMS” and “Connect an API” for teams that want Editorial to hand off generated KIT assets directly.',
      'Keep this as an output packaging layer on top of the strong preview experience rather than replacing the existing visual review.',
    ],
    promptData: [
      'Generated asset list with type, label, body, image URLs, source article, and generation settings.',
      'Export target metadata such as CMS name, API endpoint, required fields, file format, and approval state.',
      'Bundle rules for copy-only exports, image exports, carousel packages, and multi-asset campaign kits.',
    ],
    icon: FileText,
    impact: 8,
    effort: 5,
