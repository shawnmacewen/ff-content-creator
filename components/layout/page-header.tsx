...
const headerAccentPaths: Record<keyof typeof headerVariants, {
  ...
  teal: {
    ribbon: 'M -120 126 C 160 62, 425 72, 690 99 C 935 124, 1115 128, 1365 78 C 1500 51, 1595 50, 1700 66 L 1700 116 C 1495 101, 1348 113, 1138 141 C 885 175, 658 137, 430 113 C 205 90, 18 101, -120 146 Z',
    lines: [
      { d: 'M -80 116 C 230 60, 510 70, 780 98 C 1035 125, 1240 103, 1685 58', width: 1.1, opacity: 0.78 },
      { d: 'M 1050 154 A 142 120 0 0 1 1334 154', width: 1.25, opacity: 0.58 },
    ],
  },
  pink: {
